...
- (void (^)(void))csqTapBlock
{
    
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setCsqTapBlock:(void (^)(void))csqTapBlock
{
    self.userInteractionEnabled = YES;
    objc_setAssociatedObject(self, @selector(csqTapBlock), csqTapBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
- (void)tapActionWithStrings:(NSArray <NSString *> *)strings tapClicked:(void (^) (NSString *string , NSRange range , NSInteger index))tapClick
{
...
- (void)csqTapBlock:(void (^)(void))csqTapBlock
{
    
    
    if (self.csqTapBlock != csqTapBlock) {
        self.csqTapBlock = csqTapBlock;
    }
}
