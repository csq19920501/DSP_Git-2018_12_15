...
+ (instancetype)shared{
    ...
    dispatch_once(&oneToken, ^{
        ...
        //设置文字颜色
        config.textColor = [UIColor whiteColor];//[UIColor colorWithRed:113/255.0 green:109/255.0 blue:104/255.0 alpha:1];

        //设置文字选中颜色
        config.selectedTextColor = config.textColor;
        
        //背景颜色
        config.backgroundColor = [UIColor blackColor];//[UIColor colorWithRed:254/255.0 green:254/255.0 blue:254/255.0 alpha:1];
